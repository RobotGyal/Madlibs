...
story = """A {0} was driving a wagon along a country lane, when the {1} sank down deep into a rut.
 The {2} driver, stupefied and aghast, stood looking at the wagon, and did nothing but utter loud cries to Hercules to come and help him.
...
#index = 0
#for index in madlibs:
 #   print(story.format(madlibs[index]))
#    index +=1
